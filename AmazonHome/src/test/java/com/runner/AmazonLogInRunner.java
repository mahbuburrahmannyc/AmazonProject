...
@CucumberOptions(
    ...
    features = {"src/main/resources/amazon.feature"},//feature path
...
public class AmazonLogInRunner extends AbstractTestNGCucumberTests {// remove from extends if junit
